...
public interface ParticipationRequestRepository extends JpaRepository<ParticipationRequest, Long> {
    ...
    int countByEventIdAndStatus(Long eventId, ParticipationState status);

    // for privateEventController - last 2 endpoints
    List<ParticipationRequest> findByEventIdAndStatus(Long eventId, ParticipationState status);
}
