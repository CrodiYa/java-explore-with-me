...
public class EventServiceImplTest {
    ...
    @Test
    public void shouldThrowBadRequestWhenStartAfterEndPublicEvents() {
    ...
    @Test
    public void shouldThrowNotFoundExceptionWhenEventNotExistsEventById() {
        doNothing().when(userService).throwIfUserNotFound(userId);
        when(eventRepository.findById(eventId)).thenReturn(Optional.empty());
    ...
    @Test
    public void shouldThrowNotFoundExceptionWhenEventNotExistsPatch() {
        doNothing().when(userService).throwIfUserNotFound(userId);
        when(eventRepository.findById(eventId)).thenReturn(Optional.empty());
    ...
    @Test
    public void shouldThrowNotFoundExceptionWhenEventNotExistsExists() {
